...
/*   Updated: 2023/04/04 20:28:49 by inskim           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	redirection_input(char *file_name, int status);
void	redirection_output(char *file_name, int status);
void	redirection_output_append(char *file_name, int status);
...
void    set_parse(t_list *list, t_separate_list *slist, t_parse *parse, int status);
